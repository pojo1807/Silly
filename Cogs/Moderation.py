...
class Moderation(commands.Cog):
    ...
    @BetterCommand(
        ...
        help=f"""As your **Security Cat**, I will carry out your order to **BAN** someone and make sure they can no longer return to **this house**.

** {Emojis.SecurityCat} Required Permission:**
- `ban_members` — Requires **permission to ban members**.

-# Once you meow the command, they won't be able to come back to pet or feed me...""",
        usage=f"""
This is how you can use it to **ban**:
{HelpFormat(f"{PREFIX}ban", Required={
    "@member": "@Mention the member"
}, Optional={
    "reason": "Why you want to ban this silly one?",
    "delete_messages_days": "How many days of messages to delete."
})}""",
    )
    ...
    async def ban(
        ...
        Args:
            ...
            reason (str, optional): Why you want to ban this silly one? (Default: "No meosen.", Optional)
            delete_messages_days (int, optional): How many days of messages to delete. (Default: Don't delete any messages, Optional)
        """
...
-# I'm surely you didn't mean me... {self.Emojis.JustWokeUp} """
            ...
            embed.set_thumbnail(
                url="https://media.discordapp.net/attachments/1202085160888307742/1202085161060007956/cat-cats.gif?ex=6804628c&is=6803110c&hm=cbb6c517adc24078f85c5e5ec93ab8e714fe22994e0c69e7a820eda766ec0f89&"
            )
            embed.set_image(
                url="https://media.discordapp.net/attachments/982449621290868826/1000041688326230096/09-55-29-IMG_0787.gif?ex=68045726&is=680305a6&hm=de229dff9f40711b991cc741e93c5cc99fb87506632592be93250dbb1dff7d38&"
            )
...
## Please check again **who you want to ban**, maybe *misspelled*?? {self.Emojis.JustWokeUp} """
            embed.color = discord.Color.yellow()
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/attachments/422448194476048403/1312836732554576003/togif-1_1.gif?ex=6800953c&is=67ff43bc&hm=57f6fa3cceda68201a082c04ab4dcc7e8b719f91f427771fdeecd8c4a36c5729&"
            )
        ...
        delete_messages_days = (
            MISSING if delete_messages_days == 0 else delete_messages_days
        )
...
"""
        embed.add_field(
            name=f"{self.Emojis.Seriously} Member",
            value=f"{member.mention} ({member.id})",
            inline=True,
        )
        embed.add_field(
            name=f"{self.Emojis.CatScare} Reason", value=reason, inline=True
        )
        embed.add_field(name="_ _", value="_ _", inline=False)  # new line
        embed.add_field(
            name=f"{self.Emojis.CatEatingChips} Banned by",
            value=ctx.author.mention,
            inline=True,
        )
        embed.add_field(
            name=f"{self.Emojis.UIA_Spinning} Banned at",
            value=f"<t:{int(embed.timestamp.timestamp())}:F>",
            inline=True,
        )
        embed.color = discord.Color.green()
        embed.set_thumbnail(
            url="https://cdn.discordapp.com/attachments/1312448853450162176/1312448878414397603/IMG_7880.gif?ex=68047204&is=68032084&hm=b46ba243a8cf030d8c222c0370ed9aa8e097f4544cbc64b102ccd8a281a13602&"
        )
        embed.set_image(
            url="https://cdn.discordapp.com/attachments/1218440992651218959/1255879183931019294/image_2024-06-27_213452161.gif?ex=6804f822&is=6803a6a2&hm=3d6faf4c46d121831e594e0430c61ac45318df514998ef42a5b673644b475384&"
        )
        await ctx.send(embed=embed)
